...
-   If your package requires specific system dependencies (see [*Packaging Guide*](#pkgdependencies), and links there for common dependencies) for our GitHub Action to pass, please submit a pull request adding them to [our base Dockerfile](https://github.com/ropensci-review-tools/pkgcheck/blob/main/Dockerfile).
