...
- Please also consider the time and effort needed to respond to reviews: think about your availability or that of your collaborators in the next weeks and months following a submission. We tend to be flexible with deadlines, and submissions can be put on hold but we want to avoid wasting volunteer reviewers' time.
