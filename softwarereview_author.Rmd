...
-   Read and follow [our packaging style guide](#building) and [reviewer's guide](#preparereview) to ensure your package meets our style and quality criteria.
    -   If you feel your package is in scope for the
        [Journal of Open-Source Software](https://joss.theoj.org/) (JOSS), do not submit it to JOSS consideration until after the rOpenSci review process is over: if your package is deemed in scope by JOSS editors, only the accompanying short paper would be reviewed, (not the software that will have been extended reviewed by rOpenSci by then).
