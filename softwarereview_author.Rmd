...
- As stated in [our general policies](#policies-ai), we require all submitting authors to provide details on any usage of generative AI tools in package documentation, generally in either README files or contributing guides.
  - Extended descriptions of AI tool usage or design decisions may also be held in separate documents, in which case these should be linked directly from README files or contributing guides.
...
- We strongly recommend the use of AI tools that record decisions guiding development processes and outputs within the software itself.
