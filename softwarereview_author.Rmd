...
- Please also consider the time and effort needed to respond to reviews (for your package's best!): think about your availability or those of your collaborators in the next weeks and months following a submission. We tend to be flexible with deadlines and submissions can be put on hold but we want to avoid wasting volunteer reviewers' time.
...
-   If you are no longer able to maintain your package and respond to reviews, please strive to find a successor for that role so as not to waste reviewers' time. You can also post in the rOpenSci slack workspace.
