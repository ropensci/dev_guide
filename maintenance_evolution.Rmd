...
Renaming a package that is in very early development is fine.
It can be the opportunity, before review, to comply with our [naming advice](#naming-your-package).

Now, renaming a package that has been widely adopted and/or released on CRAN is problematic.
...
The package under its old name might be a dependency of packages, scripts, and feature in documentation and blog posts, etc.

Creating a newer package that is a rewrite with a better interface, like [httr2 which is the second generation of httr](https://www.tidyverse.org/blog/2023/11/httr2-1-0-0/) ; or creating editions of a package like for [testthat](https://testthat.r-lib.org/articles/third-edition.html), are better strategies.
In particular, they allow users to choose when/whether to update their codebase to the new package or edition.
If you rewrite a package, make sure to acknowledge authors of code you re-use by listing them in DESCRIPTION with a comment that states they were author of the original package.
