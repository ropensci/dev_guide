...
Software generally has a finite lifespan, and packages may eventually need to be archived. Archived packages are moved to a dedicated GitHub organization, [ropensci-archive](https://github.com/ropensci-archive). Prior to archiving, the contents of the README file should be moved to an alternative location (such as "README-OLD.md"), and replaced with minimal contents including the following:

- Title with name of package
- A repostatus.org badge of "unsupported" for formerly released packages, or "abandoned" for former concept or WIP packages.
- One further sentence stating something like, "This package has been archived. The former README is now in README-old", with a link to the old README contents.
...
- Disable issues on GitHub (under repo settings).
- Archive the repository on GitHub (also under repo settings).
- Transfer the repository to [ropensci-archive](https://github.com/ropensci-archive), or request an rOpenSci staff member to transfer it.
