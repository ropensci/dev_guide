...
También puedes utilizar el paquete R [allcontributors](https://docs.ropensci.org/allcontributors/) para agradecer a todos los colaboradores en el archivo README.
