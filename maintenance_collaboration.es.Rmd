...
Estas y otras plantillas generalmente tendrán que ser modificadas para su uso con un paquete rOpenSci, en particular haciendo referencia y enlazando con nuestro [Código de Conducta](https://ropensci.org/code-of-conduct/) como se describe en otra sección [de este libro](#code-of-conduct).
...
- no te olvides de [**vigilar tu repositorio de GitHub**](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/managing-subscriptions-for-activity-on-github) para que te notifiquen los *issues* o *pull requests* (si trabajas de a épocas, puedes informar de esto en la guía de contribución).
