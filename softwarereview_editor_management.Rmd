...
* Remove them from https://github.com/orgs/ropensci/teams/editors/members

* Remove them from the ropensci/software-review repository.

* Inform rOpenSci community manager or some other staff emember so that they're moved to alumni team members on the website.
