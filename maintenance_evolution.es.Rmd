...
Si también se mantiene el paquete antiguo, puedes hacer una depreciación suave del mismo con un mensaje de inicio, como en httr.
Esto permite que las personas que  usan el paquete y a los autores de otros paquetes puedan elegir si actualizan su código al nuevo paquete o edición y cuándo hacerlo.
Si copias código de otro paquete, asegúrate de reconocer a las personas autoras del código que reutilizas listándolos en DESCRIPTION con un comentario que indique que fueron autores del paquete original.
