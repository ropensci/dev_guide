...
Cuando usen `z`, como no es un parámetro en la definición de la función, es probable que sea capturado por los `...` y se ignore silenciosamente -- no es lo que quieres.
...
-   En la próxima versión (`v0.3.0`) puedes hacer que la función sea caduca (es decir, que desaparezca completamente del paquete, excepto por una página _man_ con una nota sobre ella).
