...
The [second section](#onboardingintro) is dedicated to rOpenSci's onboarding process: what it is, our policies, and specific guides for authors, editors and reviewers througout the process.
