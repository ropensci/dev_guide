...
* https://github.com/ropensci for more mature packages, including some developed by rOpenSci staff and some developed by community members whose packages have gone through [review and onboarding](#onboardingintro)
