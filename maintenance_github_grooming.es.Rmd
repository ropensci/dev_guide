...
- Si tu repo contiene código no de tu autoría, por ejemplo, código JavaScript, añade `inst/js/* linguist-vendored` a .gitattributes (como en [este ejemplo](https://github.com/ropensci/wellknown/blob/4435eb620eeae346d2cab7d62276c29dee29a898/.gitattributes#L1)).
...
Del mismo modo, tu repositorio no podrá aparecer entre los [repos de R de tendencia](https://github.com/trending/r).
