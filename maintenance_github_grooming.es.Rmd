...
### Áreas de repositorio en GitHub

Las [áreas del repositorio](https://blog.github.com/2017-01-31-introducing-topics/) de GitHub ayudan a navegar y buscar en los repositorios de GitHub, y son usados por [`codemetar`](https://github.com/ropensci/codemetar) en las palabras clave del registro de rOpenSci.
