...
Las [áreas del repositorio](https://blog.github.com/2017-01-31-introducing-topics/) de GitHub ayudan a navegar y buscar en los repositorios de GitHub, son usados por [R-universe en paginas de paquetes y para resultados de busquedad](https://github.com/r-universe-org/help#how-to-add-keyword-labels-to-an-r-package), y son usados por [`codemetar`](https://github.com/ropensci/codemetar) en las palabras clave del registro de rOpenSci.
