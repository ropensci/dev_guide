...
This chapter contains a [general intro](#whatisonboarding) to our onboarding system for packages, [reasons to submit a package](#whysubmit), [reasons to volunteer as a reviewer](#whyreview), [why our reviews are open](#whyopen), and acknowledgements of [actors of the system](#editors-and-reviewers).
```

## What is rOpenSci onboarding? {#whatisonboarding}
