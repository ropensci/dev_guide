...
- Você não deve fazer nenhuma alteração no seu pacote enquanto ele estiver em análise, para que todos os revisores estejam avaliando o mesmo software. Não envie seu pacote até que ele esteja em uma versão estável!
...
- Enquanto seu pacote estiver em análise, por favor, não faça nenhuma alteração, exceto correções de emergência. Afinal, os revisores precisam poder analisar a versão mais recente (a melhor até o momento) do seu software, e essa versão não deve sofrer alterações.
