...
- Para envios em ramificações não padrão, o URL do “Repository” no modelo de envio deve ser o URL completo da ramificação de revisão, como “https://github.com/my/repo/tree/ropensci-software-review”.
