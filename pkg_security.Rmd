...
For more details and workflow advice, refer [to the gargle article "Managing tokens securely"](gargle.r-lib.org/articles/articles/managing-tokens-securely.html) and the [security chapter of the HTTP testing in R book](https://books.ropensci.org/http-testing/security-chapter.html).
