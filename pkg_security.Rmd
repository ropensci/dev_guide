...
* In the GitHub issue template, it should be stated not to share any credentials. If your user accidentally shares credentials in an issue, make sure they're aware of that so they can't revoke the key.
