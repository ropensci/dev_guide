...
* For bigger secrets like tokens, refer [to the gargle guidance](gargle.r-lib.org/articles/articles/managing-tokens-securely.html) that involves in particular the encryption of tokens for sharing them with Travis. Document the steps you made in [CONTRIBUTING.md](#friendlyfiles) so you, or say a new maintainer, can remember how to do that next time.
