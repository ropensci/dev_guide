...
- Recomendamos encarecidamente que los paquetes rOpenSci utilicen el versionado semántico. Puedes encontrar una explicación detallada en el [del libro de paquetes de R](https://r-pkgs.org/lifecycle.html).
