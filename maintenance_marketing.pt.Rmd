...
- Quando você [liberar](#releasing) uma nova versão do seu pacote ou você lançá-lo pela primeira vez no CRAN,
  ...
  - Publique sobre seu pacote nas mídias sociais (Mastodon, Bluesky, LinkedIn...) usando a hashtag “#rstats” e marque a rOpenSci se ela estiver presente nessa plataforma! Isso pode ajudar no envolvimento do colaborador/usuário. [Exemplo](https://twitter.com/opencpu/status/1003934871830622208).
