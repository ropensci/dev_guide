...
[usethis oferece suporte a configuração de CI para outros sistemas](https://usethis.r-lib.org/reference/ci.html) embora essas funções estejam ligeiramente obsoletas. rOpenSci também oferece suporte ao pacote [círculo](https://docs.ropensci.org/circle/) que auxilia na configuração de pipelines CircleCI, e ao pacote [tic](https://docs.ropensci.org/tic/) para criar pipelines de CI mais complicadas.
...
- Instalação em cache de pacotes. O padrão faz isso [r-lib/actions workflows](https://github.com/r-lib/actions).
