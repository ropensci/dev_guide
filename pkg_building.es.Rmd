...
- Recomendamos fuertemente elegir nombres cortos y descriptivos en minúsculas.
  ...
  Puedes comprobar si el nombre de tu paquete está disponible, es informativo y no es ofensivo utilizando la función [`pak::pkg_name_check()`](https://pak.r-lib.org/reference/pkg_name_check.html); también utiliza un motor de búsqueda porque asi verías si es ofensivo en otras idiomas que inglés.
