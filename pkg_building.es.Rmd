...
### Paquetes que envuelven software externo {#external-software}
...
El libro [_R packages_ (Paquetes de R)](https://r-pkgs.org/description.html#sec-description-authors-at-r) incluye una sección muy útil sobre licencias.
...
- Recomendamos utilizar [testthat](https://testthat.r-lib.org/) para escribir los *tests*. Otro paquete es [tinytest](https://journal.r-project.org/archive/2021/RJ-2021-056/index.html).
