...
- Las confirmaciones de Git breves e informativas permiten comprender y depurar mejor un proyecto. No agrupes demasiados cambios no relacionados en una sola confirmación; evita usar mensajes de confirmación sin sentido, como «actualización» o «confirmación». No exigimos un historial de Git impecable, pero recomendamos encarecidamente que te esfuerces por lograrlo. Recursos útiles:
