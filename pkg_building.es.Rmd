...
- Los *tests* deben ser fáciles de entendery lo más autocontenidos posible. Si usas testthat, evita utilizar código de alto nivel, es decir, código fuera de `test_that()`. Recomendamos leer los ["high-level principles for testing" (principios de alto nivel para pruebas)](https://r-pkgs.org/testing-design.html#sec-testing-design-principles) en el libro R Packages (Paquetes de R).
