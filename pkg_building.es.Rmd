...
- CRAN exige que los archivos CITATION se declaren como [`bibentry` items](https://stat.ethz.ch/R-manual/R-devel/library/utils/html/bibentry.html) y no en la forma previamente aceptada de [`citEntry()`](https://stat.ethz.ch/R-manual/R-devel/library/utils/html/citEntry.html).
