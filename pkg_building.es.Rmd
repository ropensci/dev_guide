...
- El nombre de rama por defecto no debe ser `master` ya que puede resultar ofensivo para algunas personas. Consulta el [declaración del proyecto Git y de la Software Freedom Conservancy](https://sfconservancy.org/news/2020/jun/23/gitbranchname/) para más contexto. Es práctica general nombrar una rama por defecto `main` aunque también pueden utilizarse otros nombres. Consulta la entrada del blog de tidyverse ["Cambiar el nombre de la rama por defecto"](https://www.tidyverse.org/blog/2021/10/renaming-default-branch/) para aprender a utilizar esta funcionalidad para ayudar a renombrar las ramas por defecto.
