...
El libro [R packages (Paquetes de R)](https://r-pkgs.org/description.html#sec-description-authors-at-r) incluye una útil sección sobre licencias.

Si tu paquete incluye código de otras fuentes, también necesita reconocer a los autores del código original en su archivo DESCIPTION, generalmente con un rol de propietario del copyright: `role = "cph"`.
Para saber cómo actualizar su archivo DESCRIPTION, consulta el libro [R packages (Paquetes de R)](https://r-pkgs.org/description.html#sec-description-authors-at-r).
...
- Para evitar que los ejemplos se ejecuten en CRAN (por ejemplo, si requieren autenticación), tienes que utilizar `\dontrun{}`.
  ...
  Consulta también la etiqueta `@exampleIf`.
