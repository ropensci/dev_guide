...
- Para incluir ejemplos, puedes utilizar el clásico `@examples` (plural "examples"), pero también la etiqueta `@example <path>` (singular "example") para almacenar el código de ejemplo en un script R independiente (idealmente en `man/`), y la etiqueta `@exampleIf` para ejecutar ejemplos condicionalmente y evitar fallos de `R CMD check`. Consulta [documentación de roxygen2 sobre ejemplos](https://roxygen2.r-lib.org/articles/rd.html#examples).
