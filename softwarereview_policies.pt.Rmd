...
- **recuperação de dados** Pacotes para acessar e fazer download de dados de fontes online com aplicações científicas.
  Nossa definição de aplicações científicas é ampla, incluindo serviços de armazenamento de dados, periódicos e outros servidores remotos, já que muitas fontes de dados podem ser de interesse dos pesquisadores.
  Entretanto, os pacotes de recuperação devem se concentrar em dados *fontes de dados* ou *tópicos* em vez de *serviços* e deve fazer [mais do que apenas baixar dados](https://ropensci.org/blog/2022/06/16/publicize-api-client-yes-no).
