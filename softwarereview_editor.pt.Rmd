...
- procure usuários do pacote ou da fonte de dados/serviço de upstream ao qual o pacote se conecta (por meio das _issues_ de abertura no repositório, marcando-o com uma estrela, citando-o em artigos, falando sobre ele na plataforma X).
...
- Direcione o autor para os capítulos do guia sobre [lançamento de pacotes](#releases), [marketing](#marketing) e [como melhorar performance no GitHub](#grooming).
