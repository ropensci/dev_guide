...
* When you release a new version of your package or release it to CRAN for the first time, 
    ...
    * Consider submitting a short post about the release to [rOpenSci tech notes](https://ropensci.org/technotes/). Contact Stefanie Butland, rOpenSci Community Manager, (e.g. via Slack or stefaniebutland@gmail.com). Refer to [the guidelines about contributing a blog post](https://blogguide.ropensci.org)).
