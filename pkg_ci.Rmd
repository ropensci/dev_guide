...
For CI to be meaningful you have to have tests set up that work locally using `R CMD check`, see [testing](/building.html#testing).
...
Tests are required to pass before merging pull requests, which provides another layer of information about problems and protection against breaking your package.
...
For more details, see the [README for the **covr** package](https://github.com/r-lib/covr) for instructions, as well as `usethis::use_coverage()`. 
