...
In particular, you'll read our policies regarding [onboarding itself](#package-submission): the [review submission process](#review-submission), the [aims and scope of the onboarding system](#aims-and-scope), and [how we deal with package overlap](#overlap). This chapter also features our policies regarding [package ownership and maintenance](#ownership-after-onboarding).  
