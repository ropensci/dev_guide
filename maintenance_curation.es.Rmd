...
Este capítulo resume una política de gestión propuesta para el mantenimiento continuo de los paquetes desarrollados como parte de las actividades de rOpenSci y/o bajo la organización rOpenSci GitHub. 
...
- Gestionar el esfuerzo de mantenimiento para el personal de rOpenSci, quienes mantienen paquetes y quienes contribuyen voluntariamente.
...
Contiene metadatos esenciales de los paquetes, incluyendo el estado de desarrollo y revisión, y es la fuente de los datos mostrados en sitios web, etiuquetas, etc...
...
Los paquetes mantenidos por el personal son desarrollados y mantenidos por el personal de rOpenSci como parte de los proyectos de rOpenSci. 
Estos paquetes pueden ser revisados por pares o no. 
Muchos son paquetes de infraestructura están fuera del alcance de la revisión por pares.

- Los paquetes mantenidos por el personal aparecerán en el registro con la etiqueta "staff_maintained" y aparecerán en la página web de paquetes de rOpenSci o en lugares similares con la etiqueta "staff-maintained".

- Estos paquetes se almacenarán en la organización GitHub "ropensci".

- Los paquetes mantenidos por el personal serán comprobados, y su documentación sera generada por el [sistema](https://status.ropensci.org/) de rOpenSci. 
...
- Cuando las comprobaciones de un paquete fallen, el personal de rOpenSci se esforzará en corregir los problemas, priorizando los paquetes en función de la base de usuarios (descargas), las dependencias inversas o los objetivos estratégicos.
...
- Los paquetes que fallan consistentemente y que no tienen un plan para volver al mantenimiento activo pasarán al estado de "archivados". Estos paquetes serán transferidos al repositorio "ropensci-archive" (pendiente a ser creado) y se les dará el tipo "archived" en el registro. 
...
- Los paquetes archivados pueden desarchivarse cuando alguien nuevo, o quien lo mantenía anteriormente, esté dispuesto a esté dispuesto a solucionar los problemas y quiera revivirlo. 
...
- Cada uno o dos años, el personal de rOpenSci revisará los paquetes que estén fallando o que han estado fallando durante largos períodos y contactará a quienes los mantienen para determinar los planes de mantenimiento y las actualizaciones previstas.
En base a esto, rOpenSci puede optar por mantener el estado actual del paquete con la expectativa de actualizaciones, contribuir a los arreglos, ayudar a buscar alguien nuevo para mantenerlo, o transferir el paquete al estado "archived".


- En función de la base de usuarios (medida por las descargas), las dependencias inversas u objetivos estratégicos de rOpenSci, el personal de rOpenSci puede asistir a los paquetes que fallan a través de PRs revisados por quienes mantienen el paquete, o cambios directos (si quienes lo mantienen no responden por aproximadamente un mes).
rOpenSci también proporcionará apoyo a pedido, tanto del personal como de personas voluntarias de la comunidad, en función del tiempo disponible.

- Si quien mantienen un paquete no responde consultas por un mes, o si ésta persona lo pide, rOpenSci puede buscar una nueva persona para mantener determinados paquetes revisados por pares que considere que tienen un alto valor para la comunidad en función de la base de usuarios (descargas), dependencias inversas o los objetivos estratégicos de rOpenSci. 
...
Obtendrán el tipo "archived" en el registro. 
...
Los paquetes "heredados" son paquetes ni creados ni mantenidos por el personal de rOpenSci ni revisados por pares, pero que están bajo la organización de rOpenSci GitHub por razones históricas.
...
Los paquetes "incubados" son paquetes en desarrollo creados por el personal o miembros de la comunidad como parte de proyectos comunitarios, como los creados en las desconferencias

- Los paquetes incubados vivirán en la organización "ropenscilabs".

- Los paquetes incubados aparecerán en el registro de paquetes con la etiqueta "incubadora".
...
- Los paquetes incubados archivados ganarán el tipo "archived".
