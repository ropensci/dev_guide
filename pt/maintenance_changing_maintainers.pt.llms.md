...
- Pacotes que foram arquivados ou [órfãos](https://cran.r-project.org/src/contrib/Orphaned/README) no CRAN não precisam da permissão do(a) mantenedor(a) anterior para serem retomados no CRAN. Nesses casos, entre em contato conosco para que possamos oferecer a ajuda necessária;
...
- O quanto você pode/deve alterar no pacote?
  ...
  Para obter ajuda geral sobre como alterar o código em um pacote, consulte a seção [Evolução do pacote](#evolution) de pacotes.
