...
_Este capítulo foi inicialmente contribuído como uma nota técnica no site da rOpenSci por [Scott Chamberlain](https://github.com/sckott); você pode ler a [versão original em inglês](https://ropensci.org/technotes/2017/01/05/package-evolution/)._
```
...
Isso permite que as pessoas usuárias e autoras de pacotes escolham se e quando devem atualizar seu código para o novo pacote ou edição.
...
[Exemplo](https://github.com/ropensci/agroclimatico/blob/2bc820cee201e27977a8a3ffa24cf7fedefe6bbd/DESCRIPTION#L25).
