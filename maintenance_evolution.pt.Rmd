...
Se você precisar depreciar um conjunto de dados fornecido pelo seu pacote, 
...
O ponto principal é o uso de [`delayedAssign()`](https://stat.ethz.ch/R-manual/R-patched/library/base/html/delayedAssign.html) para salvar uma promessa que servirá tanto para um aviso quanto para os dados.
