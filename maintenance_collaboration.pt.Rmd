...
Recomendamos que você envie comentários que não sejam um relatório de bug ou uma solicitação de *feature* para os ferramentas de discussão que sua plataforma Git oferece, como [discussões do GitHub](https://docs.github.com/en/discussions) para o GitHub.
