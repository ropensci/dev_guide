...
Ter colaboradores vai trazer melhorias para o seu pacote e, se você integrar alguns deles como autores de pacotes com [permissões de escrita no repositório](https://help.github.com/articles/repository-permission-levels-for-an-organization/), seu pacote será desenvolvido de forma mais sustentável.
...
Você pode usar o *issue*, a solicitação de *pull request* e as diretrizes de contribuição.
...
Você pode indicar aos usuários o fórum da rOpenSci se você monitorar ou ativar as [Discussões no GitHub](https://docs.github.com/en/discussions) para o seu repositório de pacotes.
...
- Não se esqueça de [**observar o seu repositório do GitHub**](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/managing-subscriptions-for-activity-on-github) para ser notificado sobre *issues* ou *pull requests* (como alternativa, se você trabalha em rajadas, talvez adicione as informações ao guia de contribuição).

- não se esqueça de enviar as atualizações que você tem localmente.

- desative os testes com falha se você não puder corrigí-los, pois eles criam ruído nos PRs que podem confundir novos colaboradores.

### Integração de colaboradores {#onboarding-collaborators}

Não existe uma regra geral da rOpenSci sobre como você deve integrar colaboradores. Você deve aumentar os direitos deles sobre o repositório à medida que ganhar confiança e, sem dúvida, deve reconhecer as contribuições deles (consulte [esta seção](#attributions)).
...
Se o seu problema for o recrutamento de colaboradores, você pode publicar uma chamada aberta como a de Jim Hester [no Twitter](https://twitter.com/jimhester_/status/997109466674819074), ou no [GitHub](https://github.com/jimhester/lintr/issues/318) e, como autor de um pacote da rOpenSci, você pode pedir ajuda no slack da rOpenSci e pedir à equipe da rOpenSci por ideias para recrutar novos colaboradores.
...
Uma das ramificações é a ramificação `main` (que é a ramificação padrão/principal), na qual, se você seguir [desenvolvimento baseado no tronco](https://www.atlassian.com/continuous-delivery/continuous-integration/trunk-based-development) você "mescla atualizações pequenas e frequentes".
...
Um aspecto específico do trabalho com colaboradores é a revisão de solicitações de *pull*, com algumas orientações úteis em:
...
- entre em contato com a equipe da rOpenSci [ou um outro membro da equipe](https://ropensci.org/about#team) para que esse novo colaborador possa receber **um convite para o espaço de trabalho do Slack da rOpenSci**.
