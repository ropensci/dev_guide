...
- Si los chequeos iniciales muestran falencias importantes, solicita cambios antes de asignar personas para la revisión.
  ...
  Recibirás un recordatorio cada 90 días (en el *issue*) para que te pongas en contacto con las personas a cargo del paquete. La etiqueta de «en espera» se puede eliminar manualmente en la barra lateral de la issue.
