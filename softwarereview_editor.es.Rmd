...
Tiene derecho a tomar decisiones de alcance y solapamiento con la mayor independencia posible (pero puede solicitar ayuda/asesoramiento), pero se le recomienda que solicite opiniones en el canal `#editors-only` en Slack.
...
- Si una consulta previa a la presentación se considera dentro del alcance, el EiC *puede* realizar comprobaciones preliminares.
  La [*plantilla de editores*](#editortemplate) puede utilizarse para ello.
...
El [*dashboard editorial de rOpenSci*](https://dashboard.ropensci.org) se actualiza a diario, principalmente extrayendo información de todos los issues de revisión de software en GitHub, junto con información adicional de Slack y de nuestra base de datos Airtable.
...
Quien ocupa el rol de LE (o cualquier editor que esté interesado) puede obtener una visión general del estado del equipo editorial, su disponibilidad y las cargas de trabajo recientes en la [página sobre *editores*](https://dashboard.ropensci.org/editors.html).
