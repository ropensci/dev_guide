...
Quien ocupa el rol de LE es responsable de la tramitación inicial de todos los nuevos envíos.
...
Quien ocupa el rol de LE (o cualquier editor que esté interesado) puede obtener una visión general del estado del equipo editorial, su disponibilidad y las cargas de trabajo recientes en [página sobre *editores*](https://dashboard.ropensci.org/editors.html).
...
- Después de contabilizar las comprobaciones automáticas, utiliza [plantilla del editor](#editortemplate) para guiar las comprobaciones iniciales (si no están ya cubiertas por quien ocupa el rol de LE) y registrar tu respuesta al envío.
