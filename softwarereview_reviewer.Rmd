...
To review a package, please begin by copying our [review template](https://github.com/ropensci/dev_guide/blob/master/templates/review.md) (or our [review template in Spanish](https://github.com/ropensci/dev_guide/blob/master/templates/review-es.md)) and using it as a high-level checklist.  In addition to checking off the minimum criteria, we ask that you provide general comments addressing the following:
