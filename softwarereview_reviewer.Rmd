...
If you interact with the package authors and talked about the review outside a review thread (in chats, DMs, in-person), please make sure that your review capture elements from these conversations that are relevant to the process.
