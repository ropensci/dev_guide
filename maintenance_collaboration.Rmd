...
You can tweak them a bit depending on your workflow and package: e.g. in CONTRIBUTING.md make sure contributors have instructions for running local test if they are not trivial. CONTRIBUTING.md can also contain some details about how you'll acknowledge contributions, and the roadmap of your package, cf [this example](https://github.com/ecohealthalliance/fasterize/blob/master/CONTRIBUTING.md).
