...
We encourage you to direct feedback that is not a bug report or a feature request to [rOpenSci forum](https://discuss.ropensci.org/). Users can use the forum to ask questions about use, and report their use cases, and where you can subscribe to categories and manage your notifications. Feel free to mention this in the docs of your package and/or the contributing guidelines/issue template. 
