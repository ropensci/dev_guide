...
You can tweak them a bit depending on your workflow and package: e.g. make sure contributors have instructions for running local test if they are not trivial.
