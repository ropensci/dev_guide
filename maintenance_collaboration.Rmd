...
You can have a look at the [tidyverse contributing.md template](https://github.com/r-lib/usethis/blob/8483d1edbec15e36ba72bf1f4fb5ab5dad44acf7/.github/CONTRIBUTING.md) for inspiration. It can be added to a package (and then modified) by using `usethis::use_tidy_contributing()`.
