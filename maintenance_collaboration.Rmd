...
You might want to pair the frequent updating with frequent version numbers incrementing (in `DESCRIPTION`).

One particular aspect of working with collaborators is reviewing pull requests. 
