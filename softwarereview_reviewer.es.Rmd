...
- ¿Pueden mejorarse el estilo del código y los patrones del código? Por ejemplo, ¿es necesario dividir las funciones en funciones auxiliares más pequeñas y está claro el papel de cada función auxiliar?
- ¿Puede reducirse el código duplicado, de haberlo?
- ¿Existen funciones en R base o en dependencias ligeras que proporcionen la misma interfaz que algunas funciones de auxiliares del paquete?
...
Algunos elementos de nuestra lista de comprobación se inspiran en la [guía de revisión de código de Mozilla](https://mozillascience.github.io/codeReview/review.html).
