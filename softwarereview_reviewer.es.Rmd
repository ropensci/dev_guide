# Guía para revisores/as {#reviewerguide}

```{block, type='summaryblock'}
¡Gracias por aceptar revisar un paquete para rOpenSci! Este capítulo consiste en nuestras recomendaciones para [preparar](#preparereview), [enviar](#submitreview) y [completar](#followupreviewer) tu revisión.

Puedes ponerte en contacto con el/la editor/a encargado/a del envío si tienes dudas sobre el proceso en general o tu revisión en particular. 

Trata de completar tu revisión en un plazo de 3 semanas desde aceptar participar de la misma. Intentaremos recordar a los/as revisores/as las fechas de vencimiento próximas y pasadas. Los/as editores/as pueden asignar
...
Consulta nuestra guía de revisores/as y el [código de conducta] (https://ropensci.org/code-of-conduct/) para más información.**
...
Si ves una presentación vigente que es particularmente relevante para tus intereses, por favor envía un correo electrónico a `info@ropensci.org`, incluyendo el nombre del paquete, la URL del número de presentación y el nombre de el/la editor/a responsable.
Sin embargo, ten en cuenta que las invitaciones a revisión son a discreción de el/la editor/a, y es muy posible que éste/a ya haya realizado invitaciones. 
Por favor, no te ofrezcas como voluntario/a para todos los temas, y no te ofrezcas a través de la interfaz de GitHub.
...
Para revisar un paquete, empieza por copiar nuestra [plantilla de revisión](#reviewtemplate) (o nuestra [plantilla de revisión en español](#reviewtemplatees)) y utilízala como checklist general. Además de marcar los criterios mínimos, te pedimos que hagas comentarios generales sobre lo siguiente:
...
Por favor, en tus revisiones sé respetuoso/a y amable con los/as autores/as. Nuestro [código de conducta](#code-of-conduct) es obligatorio para quienes participan en nuestro proceso de revisión. Esperamos que envíes tu revisión en un plazo de 3 semanas, según el plazo establecido por el/la editor/a. Por favor, ponte en contacto con él/ella directamente o mediante el hilo de envío para informarle de posibles retrasos.
...
pasar desapercibido en la computadora de el/la autor/a.
...
Puedes volver a correr la comprobación del paquete de `@ropensci-review-bot` en cualquier momento enviando un comentario en el hilo de revisión con el contenido "`@ropensci-review-bot check package`".

### Interacciones fuera del hilo

Si interactúas con los/as autores/as del paquete y hablas de la revisión fuera de un hilo de revisión (en chats, DMs, en persona, issues en el repositorio del proyecto), asegúrate de que tu revisión refleje y/o enlace los elementos de estas conversaciones que sean relevantes para el proceso.

### Experiencia de revisiones anteriores

Si es la primera vez que revisas un paquete, te puede ser útil leer algunas revisiones anteriores. En general, puedes encontrar hilos de presentación de paquetes aceptados [aquí](https://github.com/ropensci/software-review/issues?q=is%3Aissue+is%3Aclosed+label%3A6%2Fapproved). Estos son algunas revisiones seleccionadas en Inglés (ten en cuenta que tus reseñas no tienen que ser tan largas como estos ejemplos):
...
- Cuando tu revisión esté completa, agrégala como comentario en el hilo de revisión del paquete.
- Comentarios adicionales son bienvenidos en el mismo tema. Aspiramos a que las revisiones de paquetes funcionen como una conversación continua entre las partes en lugar de una única ronda de revisiones típica de los manuscritos académicos.
...
Los/as autores/as deben responder en un plazo de 2 semanas con sus cambios en el paquete en respuesta a tu revisión. En esta fase, te pedimos que respondas si los cambios abordan suficientemente las cuestiones planteadas en tu revisión. Fomentamos el debate continuo entre autores/as y revisores/as, y también puedes pedir que los/as editores/as aclaren cosas en el mismo hilo. 
