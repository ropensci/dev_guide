...
-   Staff-maintained packages will be checked via rOpenSci\'s custom CI
    system to test that they build and test successfully across
...
-   On a biannual or annual basis, rOpenSci will review all packages
    that have been failing for over a month to determine whether to transfer them to "archived" status.
