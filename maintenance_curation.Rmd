...
-   Archived packages can be unarchived when the old or a new maintainer
    ...
    package. They are transferred to the ropenscilabs organization.
...
-   When archived, these packages will move from the "ropensci" GitHub
    ...
    GitHub accounts if desired). They will gain the "archived" type
...
-   Archived packages may be un-archived if authors or a new person
    opt to resume maintenance. They are transferred to the ropenscilabs organization.
...
-   Incubator packages will live in the "ropenscilabs"
...
### General guidance for transfer to ropensci-archive or authors account
