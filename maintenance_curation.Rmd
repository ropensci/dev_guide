...
- The rOpenSci [R-universe](https://ropensci.r-universe.dev/builds)
...
- Upon acceptance, these peer-reviewed packages are transferred from
  ...
  or alternatively tracked by adding them to a [JSON file](https://github.com/ropensci/ropensci.r-universe.dev/blob/gh-pages/info/not_transferred.json).
