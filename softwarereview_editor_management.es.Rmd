...
- Por lo general, se contratan nuevos editores cuando no hay suficientes para gestionar las propuestas actuales, aunque también se puede invitar a editores invitados para propuestas concretas.

- La carga editorial actual se puede consultar en la [ página «*Editores*» de nuestro panel de control](https://dashboard.ropensci.org/editors.html)       .

### Búsqueda de un nuevo editor {#searching-for-new-editors}
   
Algunos lugares donde el responsable de Software Review puede empezar a buscar nuevos editores son:

- La [página [_Community Leaderboard_ de nuestro panel de control editorial](https://dashboard.ropensci.org/community.html), que ayuda a identificar a personas que han contribuido mucho pero que aún no han colaborado como editores.

- La lista de [*revisores y antiguos editores*](#reviewers).

- Como alternativa, se puede pedir al equipo editorial actual que aporte sugerencias y proponga candidatos.

Las decisiones sobre los nuevos editores deben tomarlas, por lo general, todo el equipo, siguiendo este procedimiento general:

- Crea un canal privado de Slack para el debate e incluye a todos los editores.
  
  - Es importante crear un nuevo canal privado para separar los debates del canal general de editores al que se unirán los futuros editores.
  
  - Envía un mensaje en el canal general de editores para asegurarte de que todos reciban una notificación sobre el nuevo canal privado.
  
  - Utiliza ese canal para solicitar candidaturas generales u opiniones sobre posibles candidatos.

- Puedes copiar y adaptar el siguiente mensaje para iniciar el canal:
  
  ````md
Os hemos invitado a todos a este canal para debatir sobre un nuevo miembro de nuestro consejo editorial.
...
Por favor, no hagáis capturas de pantalla e intentad absteneros de expresar opiniones abiertamente negativas.
   A continuación, podéis:
   - Nombrar y describir brevemente a algún candidato o candidatos concretos; o
...
- Céntrate en nuevos miembros que contribuyan a mantener la [diversidad](https://ropensci.org/blog/2025/02/05/no-science-without-deia/) y la representatividad global del equipo editorial.

- Espera a que la mayoría de los editores se pronuncien antes de invitar a alguien. Deja aproximadamente una semana para responder.

- Elimina el canal privado de Slack una vez que el nuevo editor haya aceptado la invitación.

### Invitar a un nuevo editor {#inviting-a-new-editor}
  
- Los miembros del comité editorial suelen empezar como [editores invitados](#guesteditor) para una primera presentación a modo de prueba.
...
- Una vez finalizado su mandato como editores invitados, por lo general se les pregunta si desean convertirse en miembros de pleno derecho.
