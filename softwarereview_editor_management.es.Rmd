...
Para poner en pausa a un editor:

- Elimínalo del [equipo «editors» de GitHub](https://github.com/orgs/ropensci/teams/editors), junto con el [equipo «stats-editors»](https://github.com/orgs/ropensci/teams/stats-editors) si corresponde.

- Establece su estado de «vacaciones» en Airtable, incluyendo una fecha aproximada de cuándo podrían regresar.

- Para «reactivarlos», simplemente revierte estos cambios.
