...
- **traducción**: Como parte de nuestro trabajo en [edición multilingüe](https://ropensci.org/multilingual-publishing/) tenemos especial interés en paquetes que faciliten la traducción y publicación de recursos científicos y de programación a múltiples lenguas (humanas) para que sean accesibles a públicos más amplios y diversos. Podría tratarse de interfaces para programas de traducción automática, marcos para gestionar la documentación en varias lenguas o programas que accedan a recursos lingüísticos especializados.  Se trata de un ámbito nuevo y experimental, por lo que te rogamos que abras un [issue para preguntar si el software está dentro del alcance de rOpenSci](https://github.com/ropensci/software-review/issues/new/choose) si estás interesado en presentar un paquete en esta categoría.
