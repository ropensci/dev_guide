...
- **obtención de datos**: Paquetes para acceder y descargar datos de fuentes en línea con usos científicos.
  Nuestra definición de "usos científicos" es amplia, e incluye servicios de almacenamiento de datos, revistas y otros servidores remotos, ya que existe una gran variedad de fuentes de datos que pueden ser de interés para quienes hacen ciencia.
  Sin embargo, los paquetes de obtención de datos deben centrarse en las *fuentes* o *temas* de los datos en lugar de *servicios* y deben hacer [algo más que descargar datos](https://ropensci.org/blog/2022/06/16/publicize-api-client-yes-no).
  Por ejemplo, un cliente general para el almacenamiento de datos de *Amazon Web Services* no estaría incluido, como tampoco lo estaría un paquete que sólo ofreciera funciones de descarga sin ningún tipo de preprocesamiento o filtrado previo.
...
- **traducción**: Como parte de nuestro trabajo en [publicación multilingüe](https://ropensci.org/multilingual-publishing/) tenemos especial interés en paquetes que faciliten la traducción y publicación de recursos científicos y de programación a múltiples lenguages (humanos) para que sean accesibles a públicos más amplios y diversos. 
  Podría tratarse de interfaces para programas de traducción automática, infraestructura para gestionar la documentación en varios lenguages o programas que accedan a recursos lingüísticos especializados.  
...
Tal como se describe en [nuestra publicación inicial en el blog](https://ropensci.org/blog/2026/02/26/ropensci-ai-policy/), esperamos que nuestras políticas sobre el uso de herramientas de IA generativa evolucionen a la par del desarrollo de las propias herramientas, así como de la forma en que estas contribuyen al desarrollo de software.
Esperamos que todas las personas que envíen paquetes a nuestra revisión de software por pares revelen de manera transparente cómo las herramientas de IA generativa contribuyeron al desarrollo de su paquete.
Los detalles para describir el uso de IA generativa se proporcionan tanto en la [_Guía para autores_](#authors-guide) como en la [_Guía para revisores_](#reviewerguide).
