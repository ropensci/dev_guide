...
- **obtención de datos**: Paquetes para acceder y descargar datos de fuentes en línea con usos científicos.
  Nuestra definición de "usos científicos" es amplia, e incluye servicios de almacenamiento de datos, revistas y otros servidores remotos, ya que muchas fuentes de datos pueden ser de interés para los investigadores.
