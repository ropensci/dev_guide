...
Los autores deben declarar cualquier uso de herramientas de IA generativa en nuestros formularios de envío, donde también les pedimos que:

> describan el uso e incluyan enlaces a cualquier aspecto relevante de su repositorio.

Tal como se describe en [nuestra publicación inicial en el blog](https://ropensci.org/blog/2026/02/26/ropensci-ai-policy/), se espera que nuestras políticas sobre el uso de herramientas de IA generativa evolucionen a la par del desarrollo de las propias herramientas, así como de la forma en que estas contribuyen al desarrollo de software.
Esperamos que todos los autores que envíen trabajos revelen de manera transparente cómo las herramientas de IA generativa pueden haber contribuido a cualquier software enviado para revisión por pares.
Los detalles se proporcionan tanto en la [_Guía para autores_](#authors-guide) como en la [_Guía para revisores_](#reviewerguide).
