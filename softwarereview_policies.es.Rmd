...
Como se describe en [nuestra entrada inicial en el blog](https://ropensci.org/blog/2026/02/26/ropensci-ai-policy/) se espera que nuestras políticas sobre el uso de herramientas de IA generativa evolucionen paralelamente al desarrollo tanto de las propias herramientas como de la forma en que contribuyen al desarrollo del software.
Esperamos que todos los autores que envíen trabajos revelen de forma transparente cómo han contribuido las herramientas de IA generativa a cualquier software enviado para su revisión por pares.
