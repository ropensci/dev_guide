...
- **obtención de datos**: Paquetes para acceder y descargar datos de fuentes en línea con usos científicos.
  ...
  Sin embargo, los paquetes de recuperación deben centrarse en los datos *fuentes* o *temas* en lugar de *servicios* y deben hacer [algo más que descargar datos](https://ropensci.org/blog/2022/06/16/publicize-api-client-yes-no).
