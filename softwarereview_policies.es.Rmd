...
-   **extracción de datos**: Paquetes que ayudan a recuperar datos de fuentes no estructuradas, como texto, imágenes y PDF, así como a analizar tipos de datos científicos y resultados de equipamiento científico.
...
Instamos a quienes mantienen paquetes a que se aseguren de que reciben las notificaciones de GitHub, y de que los correos electrónicos del equipo de rOpenSci y de CRAN no van a su bandeja de correo no deseado.
