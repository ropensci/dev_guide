...
- Packages that have been archived or [orphaned](https://cran.r-project.org/src/contrib/Orphaned/README) on CRAN don’t need permission of the previous maintainer to be taken over on CRAN. In these cases do get in touch with us so we can offer any help as needed.
...
- How much can/should you change in the package?
  ...
  For general help on changing code in a package, see the [Package evolution](#evolution) section.
