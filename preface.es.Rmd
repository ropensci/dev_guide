...
La [segunda sección](#softwarereviewintro) está dedicada al proceso de revisión por pares de software de rOpenSci: en qué consiste, nuestras políticas y las guías específicas orientar a  autoras/es, encargadas/os, revisoras/es y editoras/es a lo largo del proceso. 
