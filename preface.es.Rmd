...
*Si quieres contribuir a este pequeño libro (sugerencias, correcciones), dirígete a [el repositorio GitHub](https://github.com/ropensci/dev_guide) en particular [las directrices para contribuir](https://github.com/ropensci/dev_guide#contributing). Muchas gracias.*
