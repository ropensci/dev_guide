...
La [segunda sección](#softwarereviewintro) está dedicada al proceso de revisión por pares del software de rOpenSci: en qué consiste, nuestras políticas y las guías específicas para autoras/es, encargadas/os, revisoras/es y editoras/es a lo largo del proceso. Para la *revisión de software estadístico* consulta la  [página web del proyecto y los recursos asociados](https://ropensci.org/stat-software-review/).

La [tercera y última sección](#collaboration) presenta nuestras buenas prácticas para nutrir tu paquete una vez que ha sido incorporado: cómo colaborar con otras/os desarrolladoras/es, cómo documentar las publicaciones, cómo promover tu paquete y cómo aprovechar GitHub como plataforma de desarrollo. La tercera sección también incluye un [capítulo para cualquiera que desee empezar a contribuir a los paquetes de rOpenSci](#contributingguide).

Esperamos que la guía te resulte útil y clara, y agradecemos tus sugerencias en las [issue del libro](https://github.com/ropensci/dev_guide/issues). ¡Feliz desarrollo de paquetes de R!
...
*Si quieres contribuir a este libro (sugerencias, correcciones), visita [el repositorio de GitHub](https://github.com/ropensci/dev_guide) y en particular [la guía de contribución](https://github.com/ropensci/dev_guide#contributing). ¡Gracias!*
...
Por favor, avisanos si nos olvidamos de reconocer tu contribución.*
