...
Following criteria define people who cannot serve as an editor or reviewer for a submission.
...
* Within in the past three years, the potential reviewer/editor has been a collaborator or has had any other professional relationship (e.g., served as a mentor) with any person on the package who has a major role
* The potential reviewer/editor serves as a member of the advisory board for the project under review
*  The potential reviewer/editor (or close family member) would receive a direct financial benefit if the package is accepted 
* The potential reviewer/editor has an indirect financial interest from the applicant institution.
