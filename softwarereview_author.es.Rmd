...
-   Si su paquete requiere dependencias específicas del sistema (consulte la [Guía de empaquetado](#pkgdependencies) y los enlaces a las dependencias más comunes) para que nuestra acción de GitHub funcione, envíe una solicitud de extracción añadiéndolas a [nuestro Dockerfile base](https://github.com/ropensci-review-tools/pkgcheck/blob/main/Dockerfile).
