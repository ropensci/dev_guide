...
* the potential suggestions made by the submitter(s), 
...
* look for users of the package (via their opening issues in the repository, starring it, citing it in papers, talking about it on Twitter). 
...
Each submission should be reviewed by _two_ package reviewers. Although it is fine for one of them to have very little package development experience and more domain knowledge, the review should not be split in two, both reviewers need to review the package comprehensively, though from their particular perspective.
