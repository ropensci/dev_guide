...
-   Assign reviewers with `@ropensci-review-bot assign @username as reviewer` (one comment per reviewer). If needed later remove reviewers with `@ropensci-review-bot remove @username from reviewers`.
