...
-   Assign reviewers with `@ropensci-review-bot add @username to reviewers` (one comment per reviewer). If needed later remove reviewers with `@ropensci-review-bot remove @username to reviewers`.
