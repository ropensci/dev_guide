...
- Look over submissions in "review(s)-in-awaiting-changes". If there are still missing an author response after an unusually long time (red color), check whether the submission is on hold, read the thread, and contact the editor in private to ask for more information / whether the submission fell through the cracks.
