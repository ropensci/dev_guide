...
_Si utilizas nuestros estándares, listas de tareas, etc... al revisar software en otro lugar, informa a las personas a las que está destinado que haces (por ejemplo, editoras/es de revistas, estudiantes, revisión interna de código) que proceden de rOpenSci, y cuéntanoslo en [nuestro foro público](https://discuss.ropensci.org/c/usecases), o [en privado por correo electrónico](https://ropensci.org/contact/)._ 
```

## ¿Qué es la revisión por pares de software de rOpenSci? {#whatissoftwarereview}

La [suite de paquetes](https://ropensci.org/packages/) de rOpenSci recibe aportes tanto de miembros de la organización y como por miembros de la comunidad, lo que significa que se nutre de una gran diversidad de habilidades y experiencias.
