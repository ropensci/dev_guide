...
El mismo se sustenta principalmente en el trabajo voluntario: desde el rol de [edición asociada](#editors), gestionando el flujo de información y garantizando que los envíos progresen; personas que crean, envían y mejoran su paquete; [personas que revisan paquetes](#reviewers) (dos por envío), examinan el código y la experiencia de usuario.
...
### Equipo editorial asociado {#editors}
...
### Revisión y edición invitada {#reviewers}
