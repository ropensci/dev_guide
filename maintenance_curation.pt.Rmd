...
- Após a aceitação, esses pacotes revisados por pares são transferidos
  do GitHub do(a) autor(a) para dentro da organização "ropensci" no GitHub ou, alternativamente, rastreados adicionando-os a um [arquivo JSON] (https://github.com/ropensci/roregistry/blob/gh-pages/info/not_transferred.json).
