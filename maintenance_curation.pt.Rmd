...
Os pacotes revisados por pares são aqueles contribuídos para a rOpenSci pelo
...
- Após a aceitação, esses pacotes revisados por pares são transferidos
  do GitHub do autor para dentro da organização "ropensci" no GitHub
...
- Os pacotes de incubadoras arquivados ganharão o tipo "archived".
