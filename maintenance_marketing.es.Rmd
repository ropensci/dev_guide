...
-   Cuando [publiques](#releasing) una nueva versión de tu paquete o lo publiques en CRAN por primera vez,
    ...
    -   Considera enviar un breve post sobre el lanzamiento a [rOpenSci tech notes](https://ropensci.org/technotes/).
...
-   Si decides promocionar tu paquete dando una charla sobre él en una reunión o conferencia (¡excelente idea!) lee en [este artículo de Jenny Bryan y Mara Averick](https://www.tidyverse.org/articles/2018/07/carpe-talk/).
