...
- Convide-os para o canal privado "somente para editores" no espaço de trabalho Slack da rOpenSci (e para o espaço de trabalho Slack em geral, se eles ainda não estiverem lá).
- Quando eles estiverem no canal "somente para editores", publique uma mensagem de boas-vindas informando todos os editores.
