...
O uso de ferramentas de IA generativa é aceitável tanto para autores quanto para revisores; no entanto, essas ferramentas não podem ser utilizadas pelos revisores para fundamentar quaisquer decisões ou recomendações sem supervisão humana.

Assim como esperamos dos autores, exigimos que os revisores divulguem qualquer uso de ferramentas de IA generativa com o máximo de detalhes possível.
