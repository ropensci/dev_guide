...
Para facilitar a comunicação em torno deles, por favor, coloque um prefixo nas suas respostas da seguinte forma: suas iniciais — a menos que você as compartilhe com outra pessoa no tópico — e um número:
...
Dessa forma, o autor pode responder assim:
...
Obrigado, as funções agora estão agrupadas em ingestão de dados, verificação de dados e análise de dados. Veja o [novo índice de referência](pkgdown-link).
