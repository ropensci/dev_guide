...
* If there is potential overlap or confusion with other packages providing similar functionality or having a similar name, add a note in the README, main vignette and potentially the Description field of DESCRIPTION. Example in [rredlist vignette](https://docs.ropensci.org/rredlist/articles/rredlist.html), [rebird README](https://docs.ropensci.org/rebird/#auk-vs-rebird).
