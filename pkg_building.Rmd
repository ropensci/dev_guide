...
* It is good practice to write unit tests for all functions, and all package code in general. Test coverage should be at least 75% to be accepted, and ensure important areas are not missed. Below 60% would be low and probably require more tests or an explanation.
