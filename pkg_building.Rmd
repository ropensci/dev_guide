...
* For testing your functions creating plots, we recommend using [`vdiffr`](https://cran.rstudio.com/web/packages/vdiffr/index.html), an extension of the `testthat` package.
