...
* If your package provides access to a data source, we require that DESCRIPTION contains (1) Identification and/or description of the organisation responsible for issuing data; and (2) URL linking to public-facing page providing, describing, or enabling data access (which may often differ from URL leading directly to data source).
