...
## Code Style and best practice {#code-style}
...
- You can use the [lintr package](https://lintr.r-lib.org/index.html) for identifying some possible areas of improvement. [Example workflow](https://masalmon.eu/2024/08/28/lintr-3-steps/).
